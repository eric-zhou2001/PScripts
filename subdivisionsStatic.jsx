...
var scrollbarLabelGroup = mainButtonsGroup.add(
  "group",
  undefined,
  "Horizontal"
);
...
var scrollbar1Label = scrollbarLabelGroup.add(
  "statictext",
  undefined,
  "Horizontal"
);
scrollbar1Label.characters = 4;
var scrollbar2Label = scrollbarLabelGroup.add(
  "statictext",
  undefined,
  "Vertical"
);
  ...
  if (numDivisions == 0) {
    ...
    for (var i = 0; i < numDivisions; ++i) {
      guides.add(
        ...
        app.activeDocument.width * (initialGuides + 1)
      );
    }
  }
};
...
scrollbar2.onChange = function () {
  ...
  if (numDivisions == 0) {
    ...
    for (var i = 0; i < numDivisions; ++i) {
      guides.add(
        Direction.VERTICAL,
        app.activeDocument.height * (initialGuides + 1)
      );
    }
  }
};
